...
// DlgTestDoc.cpp: CDlgTestDoc 클래스의 구현
//
...
CDlgTestDoc::CDlgTestDoc() noexcept
{
...
// 축소판 그림을 지원합니다.
void CDlgTestDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CDlgTestDoc::InitializeSearchContent()
{
...
void CDlgTestDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
